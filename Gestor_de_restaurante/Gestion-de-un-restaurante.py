...
# Etiqueta titulo
etiqueta_titulo = Label(panel_superio, text="Sistema de Facturacion", fg="azure4",
                        font=("Dosis", 58), bg='aquamarine', width=27)
...
# Panel costos
panel_costos = Frame(panel_izquierdo, bd=1, relief=FLAT, bg='azure4', padx=65)
...
# Lista de productos
lista_comidas = ['pollo', 'cordero', 'salmon', 'merluza', 'kabab', 'pizza1', 'pizza2', 'pizza3']
lista_bebidas = ['agua', 'soda', 'jugo', 'cola', 'vino1', 'vino2', 'cerveza1', 'cerveza2']
lista_postres = ['helado', 'fruta', 'brownies', 'flan', 'mousee', 'pastel1', 'pastel2', 'pastel3']
...
# Etiquetas de cosoto y campos de entrada
...
# Area de recibo
texto_recibo = Text(panel_recibo, font=('Dosis', 12, 'bold'), bd=1, width=59, height=10)
texto_recibo.grid(row=0, column=0)

# Calculador
visor_calculadora = Entry(panel_calculadora, font=('Dosis', 16, 'bold'), width=44, bd=1)
visor_calculadora.grid(row=0, column=0, columnspan=5)
...
for boton in botones_calculadora:
    boton = Button(panel_calculadora, text=boton.title(), font=('Dosis', 16, 'bold'), fg='white', bg='azure4', bd=1,
                   width=8)
